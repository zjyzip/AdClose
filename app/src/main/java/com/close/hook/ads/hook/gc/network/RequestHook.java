...
public class RequestHook {
    ...
    private static Object requestHeaders;
    private static int responseCode;
    private static String responseMessage;
    private static Object responseHeaders;
    ...
    private static void sendBlockedRequestBroadcast(String type, @Nullable String requestType,
        ...
        if (currentContext != null) {
            ...
            BlockedRequest blockedRequest = new BlockedRequest(appName, packageName, request,
                    System.currentTimeMillis(), type, isBlocked, method, urlString, requestHeaders.toString(),
                    responseCode, responseMessage, responseHeaders.toString());
